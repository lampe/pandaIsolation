...
.body(function() {
  ...
  game.createClass("ParallaxBackground", {
    init: function(){
      ...
      this.levelBg = new game.TilingSprite('images/BG_Layer1.png',game.system.width,game.system.height);
      this.levelBg.position.set(game.system.width/2, game.system.height/2);
      this.levelBg.anchor.set(0.5, 0.5);

      this.levelBg2 = new game.TilingSprite('images/BG_Layer1.png',game.system.width,game.system.height);
      this.levelBg2.position.set((game.system.width+(game.system.width/2)), game.system.height/2);
      this.levelBg2.anchor.set(0.5, 0.5);

      this.levelBg3 = new game.TilingSprite('images/BG_Layer2.png',game.system.width,game.system.height);
      this.levelBg3.position.set(game.system.width/2, game.system.height/2);
      this.levelBg3.anchor.set(0.5, 0.5);

      this.levelBg4 = new game.TilingSprite('images/BG_Layer2.png',game.system.width,game.system.height);
